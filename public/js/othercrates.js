...
function showCrateDataError(message) {
...
function renderGroupedTables(items) {
  ...
  crateTableContainer.innerHTML = html;
}
...
// Tooltip (same logic as in scripts.js)
...
async function loadChangelog(page = "noncosmetic", currentPage = 1, itemsPerPage = 4) {
  try {
