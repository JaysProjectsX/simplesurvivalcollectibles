if (document.getElementById("particles-js")) {
  ...
  if (dropdownContainer && crateTableContainer) {
      ...
      fetch(
        "https://raw.githubusercontent.com/JaysProjectsX/simplesurvival-crates-data/refs/heads/main/othercrates.json"
    ...
    fetch("https://api.github.com/repos/JaysProjectsX/simplesurvival-crates-data/commits?path=othercrates.json")
    .then((res) => res.json())
    .then((commits) => {
